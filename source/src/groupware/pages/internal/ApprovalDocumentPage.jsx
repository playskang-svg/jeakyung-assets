...
export default function ApprovalDocumentPage() {
  ...
  return <article className="gw-approval-page" aria-labelledby="approval-document-title">
    ...
    {actions.can_admin_cancel && auth.activeRole === 'super_admin' && <section className="gw-approval-card gw-no-print"><h2>시스템 관리자 작업</h2><p>진행 오류나 규정 위반 문서를 사유와 함께 강제 취소합니다.</p><button className="gw-secondary-button gw-secondary-button--danger" type="button" disabled={busy} onClick={cancelByAdmin}>문서 강제 취소</button></section>}
