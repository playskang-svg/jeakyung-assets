  ...
  return (
    <>
      ...
      <div className="ceo-message">
        ...
        <p>안녕하세요. 재경닷컴 대표이사 염달성입니다. 재경은 고객의 운영이 더 안정적으로 이어지도록 현장에서 답을 찾겠습니다. 3PL 물류대행과 신선식품 풀필먼트를 중심으로 꼭 필요한 물류 해답을 함께 만들어가겠습니다. 감사합니다.</p>
        <p className="ceo-signature"><strong>염달성</strong><span>재경닷컴 대표이사</span></p>
      </div>
    </>
  );
}
